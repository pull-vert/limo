 ...
 */
public class LimoIOException extends UncheckedIOException {

    private static final IOException NOP_IO_EXCEPTION = new IOException();

    /**
     * Constructs an {@code LimoIOException}.
     */
    public LimoIOException() {
        super(NOP_IO_EXCEPTION);
    }

    /**
     * Constructs an {@code LimoIOException} with the specified detail message.
     *
     * @param message The detail message (which is saved for later retrieval
     *                by the {@link #getMessage()} method)
     * @throws NullPointerException if the message is {@code null}
     */
    public LimoIOException(@NotNull String message) {
     ...
     */
    public LimoIOException(@NotNull String message, @NotNull IOException cause) {
        super(Objects.requireNonNull(message), Objects.requireNonNull(cause));
    }

    /**
     * Constructs an  {@code LimoIOException} with the specified cause and a
     ...
     */
    public LimoIOException(@NotNull IOException cause) {
